...
**Local snapshot (when fetch enabled):** `data/downloads/huggingface_commitpackft/`  
...
This calls `snapshot_download` for `bigcode/commitpackft` into `data/downloads/huggingface_commitpackft/`. The first run can take significant time and disk space.
