...
**Download directory:** `data/downloads/kaggle_github_repos/` (after successful fetch)
...
The orchestrator runs `kaggle datasets download -d donbarbos/github-repos` into `data/downloads/kaggle_github_repos/` and `--unzip` when supported.

## Manual alternative

Download the CSV/ZIP from the Kaggle dataset page and extract into **`data/downloads/kaggle_github_repos/`** yourself. Document the file name you used in your merge notebook.
